...
<body dir="ltr" id="home" class=" ">
    ...
    <div class="l-wrapper">
        <!-- HEADER -->
        <?php $this->viewPartial("header"); ?>
        <?php $this->viewPartial("index"); ?>
        <!-- FOOTER -->
        <div class="l-footer">
            <footer class="l-constrained">
                <ul class="l-list-four-col l-clearfix">
                    <li> <span class="link-header">Game</span>
                        <ul class="l-list-vertical">
                            <li><a class="link-alt">&raquo; <?php echo Globals::TWLAN_VERSION." (".Globals::TWLAN_REVISION.")"; ?></a>
                            </li>
                        </ul>
                    </li>
                    <li> <span class="link-header">Community</span>
                        <ul class="l-list-vertical">
                            <li><a class="link-alt" href="http://twlan.org" target="_blank">&raquo; Forum</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="l-clearfix">
                    <div class="links-footer l-clearfix l-center-block"> <a href="http://www.the-west.net/?ref=ds_zz" target="_blank">The West</a> <span>&bull;</span> <a href="http://en.grepolis.com/?ref=ds_zz" target="_blank">Grepolis</a> <span>&bull;</span> <a href="http://en.forgeofempires.com/?ref=ds_zz" target="_blank">Forge of Empires</a> <span>&bull;</span> <a href="https://en.tribalwars2.com/?ref=ds_zz" target="_blank">Tribal Wars 2</a> <span>&bull;</span> <a href="https://en.elvenar.com/?ref=ds_zz" target="_blank">Elvenar</a> </div>
                    <div class="links-footer l-clearfix l-center-block"> <a href="http://www.innogames.com/">&copy; 2003 - 2014 InnoGames GmbH </a> <span>&bull;</span> <a href="http://legal.innogames.com/staemme/zz/imprint">Imprint</a><span>&bull;</span> <a href="http://legal.innogames.com/staemme/zz/privacy">Privacy</a><span>&bull;</span> <a href="http://legal.innogames.com/staemme/zz/agb">Terms &amp; Conditions</a> 
                    <a>&copy; 2014 TWLan &amp; Contributors</a>
                    </div>
                    <!-- end .l-inline-list l-clearfix -->
                </div>
                <!-- end .l-clearfix -->
            </footer>
            <!-- end .l-constrained--><a id="up" class="one transparent" href="#top">? Go to the top</a>
            <!-- end #up -->
        </div>
        <!--end .l-footer-->
    </div>
    ...
    <script>
        try
        {
            ...
            {
                var _instance = this;
                var _iRefreshCrossSellingPauseOnItems = 9000;
                var _sExternalRef = null;
                var _eContainer = $j('#pbar');
                var _aIntervalIds = {};
                var _aObservers = {};
                var _bInitialized = false;
                var _bTickerInitialized = false;
                var _bVisible = true;
                this.EVNT_PB_SHOW = 'pbar.show';
                this.EVNT_PB_HIDE = 'pbar.hide';
                var _init = function()
                {
                    _parseExternalRef();
                    _build();
                ...
                var _build = function()
                {
                    _eContainer.find("#pb-tab-slide-open").hide();
                    _eContainer.find("#pb-tab-slide-close").show();
                    _eContainer.find("#pb-tab-slide-open").click(function()
                    {
                        $j("div.pb-outer").slideToggle("fast");
                        _eraseCookie('pBarVisibility');
                        _instance.trigger(_instance.EVNT_PB_SHOW);
                        _bVisible = true;
                    });
                    _eContainer.find("#pb-tab-slide-close").click(function()
                    {
                        $j("div.pb-outer").slideUp("fast");
                        _createCookie('pBarVisibility', 'hide', 14);
                        _instance.trigger(_instance.EVNT_PB_HIDE);
                        _bVisible = false;
                    });
                    _eContainer.find(".pb-tab a").click(function()
                    {
                        $j(".pb-tab a").toggle();
                        return false;
                    });
                    var sPBarVisibility = _readCookie('pBarVisibility');
                    if (sPBarVisibility && sPBarVisibility == 'hide')
                    {
                        _eContainer.find('.pb-outer').hide();
                        _eContainer.find('#pb-tab-slide-open').show();
                        _eContainer.find('#pb-tab-slide-close').hide();
                        _bVisible = false;
                    }
                    else
                    {
                        _eContainer.find('.pb-outer').show();
                        _eContainer.find('#pb-tab-slide-open').hide();
                        _eContainer.find('#pb-tab-slide-close').show();
                        _bVisible = true;
                    }
                    _eContainer.find('.pb-outer').show();
                    _bVisible = true;
                    _eContainer.find('.pb-moregames-overview li').hover(function()
                    {
                        $j(".pb-caption", this).stop().animate(
                        {
                            top: '0px'
                        },
                        {
                    ...
                    _eContainer.find('.pb-cntnt .pb-moregames-sec .pb-moregames-overview-lists').toggle();
                    _eContainer.find('.pb-cntnt .pb-moregames-sec .pb-moregames-overview-lists').hover(function()
                    {
                        $j(this).show(50);
                    }, function()
                    {
                    ...
                    _eContainer.find(".pb-cntnt .pb-lang-sec .pb-lang-sec-options").toggle();
                    _eContainer.find(".pb-cntnt .pb-lang-sec .pb-lang-sec-options").hover(function()
                    {
                        $j(this).show(50);
                    }, function()
                    {
                    ...
                    _eContainer.find('.pb-cntnt .pb-moregames-sec .pb-moregames-overview-lists').hide();
                    _eContainer.find('.pb-cntnt .pb-lang-sec .pb-lang-sec-options').hide();
                    _eContainer.find('.pb-cntnt .pb-lang-sec .pb-lang-select').bind('click', function()
                    {
                        _eContainer.find(".pb-cntnt .pb-lang-sec .pb-lang-sec-options").toggle();
                        _eContainer.find(".pb-cntnt .pb-lang-sec .pb-lang-sec-options").hover(function()
                        {
                    ...
                    _eContainer.find('.pb-cntnt .pb-moregames-sec .pb-moregames-select').bind('click', function()
                    {
                        _eContainer.find('.pb-cntnt .pb-moregames-sec .pb-moregames-overview-lists').toggle();
                        _eContainer.find('.pb-cntnt .pb-moregames-sec .pb-moregames-overview-lists').hover(function()
                        {
                    ...
                    if (_sExternalRef != null)
                    {
                        var eIgLink = _eContainer.find('.pb-home a');
                        var aFlags = _eContainer.find('.pb-lang-sec-options ul li a');
                        var aGames = _eContainer.find('ul.pb-moregames-overview li a');
                        var aCpFeeds = _eContainer.find('ul#pb-ticker-news li a');
                        eIgLink.each(function()
                        {
                            _replaceRef($(this), _sExternalRef);
                        });
                        aFlags.each(function()
                        {
                            _replaceRef($(this), _sExternalRef);
                        });
                        aGames.each(function()
                        {
                            _replaceRef($(this), _sExternalRef);
                        });
                        aCpFeeds.each(function()
                        {
                            _replaceRef($(this), _sExternalRef);
                        });
                    }
                    var eTicker = _eContainer.find('.pb-sec-news .pb-news .pb-news-content ul#pb-ticker-news');
                    if (eTicker.length > 0)
                    {
                        _eContainer.find('.pb-sec-news .pb-news').show();
                        if (!_bTickerInitialized)
                        {
                            eTicker.ticker(
                            {
                                debugMode: true,
                                titleText: '',
                                displayType: 'fade',
                                pauseOnItems: _iRefreshCrossSellingPauseOnItems
                            });
                            _bTickerInitialized = true;
                        }
                        else
                        {
                            eTicker.unbind();
                ...
                var _replaceRef = function(eAnker, sExternalRef)
                {
                    var sUrl = eAnker.attr('href');
                    var sUrl = sUrl.replace(/ref=[\w_]+/, 'ref=' + sExternalRef);
                    eAnker.attr('href', sUrl);
                }
                var _parseExternalRef = function()
                {
                    sQuery = document.location.search.substr(1, document.location.search.length);
                    if (sQuery != '')
                    {
                        aKeysAndVals = sQuery.split('&');
                        for (i = 0; i < aKeysAndVals.length; ++i)
                        {
                            aKeyValTuple = aKeysAndVals[i].split('=');
                            if (aKeyValTuple.length > 1)
                            {
                                if (aKeyValTuple[0] == 'ref')
                                {
                                    _sExternalRef = aKeyValTuple[1];
                                    break;
                                }
                            }
                        }
                ...
                var _createCookie = function(sName, sValue, iDays)
                {
                    var sExpires = "";
                    if (iDays)
                    {
                ...
                var _readCookie = function(sName)
                {
                    var sNameEQ = sName + "=";
                    var aPieces = document.cookie.split(';');
                    for (var i = 0; i < aPieces.length; i++)
                    {
                        var sValue = aPieces[i];
                ...
                var _eraseCookie = function(sName)
                {
                    _createCookie(sName, "", -1);
                };
                this.observe = function(sEventName, fCallback)
                {
                    if (!_aObservers[sEventName])
                    {
                        _aObservers[sEventName] = new Array();
                    }
                    _aObservers[sEventName].push(fCallback);
                    return fCallback;
                };
                this.unobserve = function(sEventName, fCallback)
                {
                    if (!_aObservers[sEventName])
                    {
                        return false;
                    ...
                    if (null == fCallback)
                    {
                        _aObservers[sEventName] = [];
                    }
                    var iIdx = $j.inArray(fCallback, _aObservers[sEventName]);
                    if (iIdx < 0)
                    {
                        return false;
                    }
                    _aObservers[sEventName].splice(iIdx, 1);
                    return true;
                };
                this.trigger = function()
                {
                    ...
                    var sName = a.shift();
                    if (!_aObservers[sName])
                    {
                        return;
                    }
                    for (var i in _aObservers[sName])
                    {
                        _aObservers[sName][i].apply(undefined, a);
                    }
                };
            ...
            (function($j)
            {
                $j.fn.ticker = function(options)
                {
                    var opts = $j.extend(
                    {}, $j.fn.ticker.defaults, options);
                    var newsID = '#' + $j(this).attr('id');
                    var tagType = $j(this).get(0).tagName;
                    return this.each(function()
                    {
                        var settings = {
                            ...
                            dom:
                            {
                                contentID: '#pb-ticker-content',
                                titleID: '#pb-ticker-title',
                                titleElem: '#pb-ticker-title SPAN',
                                tickerID: '#pb-ticker',
                                wrapperID: '#pb-ticker-wrapper',
                                revealID: '#pb-ticker-swipe',
                                revealElem: '#pb-ticker-swipe SPAN',
                                controlsID: '#pb-ticker-controls',
                                prevID: '#pb-prev',
                                nextID: '#pb-next',
                                playPauseID: '#pb-play-pause'
                            }
                        };
                        ...
                        {
                            $j(settings.dom.wrapperID).append('<div id="' + settings.dom.tickerID.replace('#', '') + '"><div id="' + settings.dom.titleID.replace('#', '') + '"><span><!-- --></span></div><p id="' + settings.dom.contentID.replace('#', '') + '"></p><div id="' + settings.dom.revealID.replace('#', '') + '"><span><!-- --></span></div></div>');
                            $j(settings.dom.wrapperID).removeClass('no-js').addClass('has-js ' + opts.direction);
                            $j(settings.dom.tickerElem + ',' + settings.dom.contentID).hide();
                            if (opts.controls)
                            {
                                $j(settings.dom.controlsID).live('click mouseover mousedown mouseout mouseup', function(e)
                                {
                                    ...
                                    if (e.type == 'click')
                                    {
                                        switch (button)
                                        {
                                            case settings.dom.prevID.replace('#', ''):
                                                ...
                                                $j(settings.dom.playPauseID).addClass('paused');
                                            ...
                                            case settings.dom.playPauseID.replace('#', ''):
                                                ...
                                                else
                                                {
                                                    ...
                                                    $j(settings.dom.playPauseID).removeClass('paused');
                                                    restartTicker();
                                                }
                                                break;
                                        }
                                    }
                                    else if (e.type == 'mouseover' && $j('#' + button).hasClass('controls'))
                                    {
                                        $j('#' + button).addClass('over');
                                    }
                                    else if (e.type == 'mousedown' && $j('#' + button).hasClass('controls'))
                                    {
                                        $j('#' + button).addClass('down');
                                    }
                                    else if (e.type == 'mouseup' && $j('#' + button).hasClass('controls'))
                                    {
                                        $j('#' + button).removeClass('down');
                                    }
                                    else if (e.type == 'mouseout' && $j('#' + button).hasClass('controls'))
                                    {
                                        $j('#' + button).removeClass('over');
                                    }
                                });
                                $j(settings.dom.wrapperID).append('<ul id="' + settings.dom.controlsID.replace('#', '') + '"><li id="' + settings.dom.playPauseID.replace('#', '') + '" class="controls"></li><li id="' + settings.dom.prevID.replace('#', '') + '" class="controls"></li><li id="' + settings.dom.nextID.replace('#', '') + '" class="controls"></li></ul>');
                            }
                            if (opts.displayType != 'fade')
                            {
                                $j(settings.dom.contentID).mouseover(function()
                                {
                        ...
                        function processContent()
                        {
                            if (settings.contentLoaded == false)
                            {
                                ...
                                {
                                    if ($j(newsID + ' LI').length > 0)
                                    {
                                        $j(newsID + ' LI').each(function(i)
                                        {
                        ...
                        {
                            settings.contentLoaded = true;
                            $j(settings.dom.titleElem).html(settings.newsArr['item-' + settings.position].type);
                            $j(settings.dom.contentID).html(settings.newsArr['item-' + settings.position].content);
                            ...
                            distance = $j(settings.dom.contentID).width();
                        ...
                        {
                            $j(settings.dom.contentID).css('opacity', '1');
                            if (settings.play)
                            {
                                var offset = $j(settings.dom.titleElem).width() + 20;
                                $j(settings.dom.revealID).css(opts.direction, offset + 'px');
                                if (opts.displayType == 'fade')
                                {
                                    $j(settings.dom.revealID).hide(0, function()
                                    {
                                        $j(settings.dom.contentID).css(opts.direction, offset + 'px').fadeIn(opts.fadeInSpeed, postReveal);
                                    });
                                }
                                ...
                                {
                                    $j(settings.dom.revealElem).show(0, function()
                                    {
                                        $j(settings.dom.contentID).css(opts.direction, offset + 'px').show();
                                        ...
                                        $j(settings.dom.revealID).css('margin-' + opts.direction, '0px').delay(20).animate(animationAction, time, 'linear', postReveal);
                                    });
                                }
                            }
                            else
                        ...
                        function postReveal()
                        {
                            if (settings.play)
                            {
                                $j(settings.dom.contentID).delay(opts.pauseOnItems).fadeOut(opts.fadeOutSpeed);
                                if (opts.displayType == 'fade')
                                {
                                    $j(settings.dom.contentID).fadeOut(opts.fadeOutSpeed, function()
                                    {
                                        $j(settings.dom.wrapperID).find(settings.dom.revealElem + ',' + settings.dom.contentID).hide().end().find(settings.dom.tickerID + ',' + settings.dom.revealID).show().end().find(settings.dom.tickerID + ',' + settings.dom.revealID).removeAttr('style');
                                        setupContentAndTriggerDisplay();
                                    });
                                }
                                else
                            ...
                            {
                                $j(settings.dom.revealElem).hide();
                            }
                        }
                        ...
                        {
                            settings.play = false;
                            $j(settings.dom.tickerID + ',' + settings.dom.revealID + ',' + settings.dom.titleID + ',' + settings.dom.titleElem + ',' + settings.dom.revealElem + ',' + settings.dom.contentID).stop(true, true);
                            $j(settings.dom.revealID + ',' + settings.dom.revealElem).hide();
                            $j(settings.dom.wrapperID).find(settings.dom.titleID + ',' + settings.dom.titleElem).show().end().find(settings.dom.contentID).show();
                        }
    ...
    <script>
        StartPage.uris = {
            ...
            register_validate: '/page/register/validate',
