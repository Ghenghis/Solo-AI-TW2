...
* TWLan: commented header("X-Frame-Options: deny");
* TWLAN: verify_token: if (defined("TWLAN_ADMINER_POST")) return true;
* TWLAN: dumpDataba: insert if(defined("TWLAN_SEP_INSERTS")){$ge=0;} after $ge=($w=="sqlite"?0:1048576);
...
verify_token(){if (defined("TWLAN_ADMINER_POST")) return true;list($T,$Pf)=explode(":",$_POST["token"]);return($Pf^$_SESSION["token"])==$T;}function
...
dumpData($Q,$Mg,$H){global$h,$w;$ge=($w=="sqlite"?0:1048576);if(defined("TWLAN_SEP_INSERTS")){$ge=0;}if($Mg){if($_POST["format"]=="sql"){if($Mg=="TRUNCATE+INSERT")echo
